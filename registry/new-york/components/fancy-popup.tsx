...
function FancyPopup({
    ...
    return (
        <FancyPopupContext.Provider value={{ animation }}>
...
function FancyPopupFooter({
    ...
    animation = 'ripple',
    ...props
}: React.ComponentProps<typeof motion.div> & { animation?: AnimationVariant }) {
...
function FancyPopupTitle({
    ...
    animation = 'ripple',
    ...props
}: React.ComponentProps<typeof motion.h2> & { animation?: AnimationVariant }) {
