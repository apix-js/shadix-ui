                    ...
                    >
                        <div className="mb-8">
                            ...
                            <p className="text-xl md:text-2xl text-muted-foreground mb-8 max-w-3xl mx-auto leading-relaxed">
                                ...
                                components built on top of shadcn/ui. Enhanced
                                with modern animations and advanced
                                interactions.
                            </p>
                        </div>
                        ...
                        >
                            <Card className="h-full">
                                <CardHeader>
                                    ...
                                    <CardDescription>
                                        Fully customizable components that adapt
                                        to your design system and brand
                                        identity.
                                    </CardDescription>
                                </CardHeader>
                            </Card>
                        ...
                        >
                            <Card className="h-full">
                                <CardHeader>
                                    ...
                                    <CardDescription>
                                        Built with TypeScript, fully typed, and
                                        easy to integrate into your existing
                                        projects.
                                    </CardDescription>
                                </CardHeader>
                            </Card>
                        ...
                        >
                            <Card>
                                <CardHeader>
                                    ...
                                    <CardDescription>
                                        A button that displays a confirmation
                                        popup when clicked, perfect for
                                        destructive actions.
                                    </CardDescription>
                                </CardHeader>
                                <CardContent className="space-y-4">
                                    ...
                                    <div className="text-sm text-muted-foreground">
                                        <strong>Features:</strong> Loading
                                        states, toast notifications,
                            ...
                            <Card>
                                <CardHeader>
                                    ...
                                    <CardDescription>
                                        ...
                                        animations and multiple animation
                                        variants.
                                    </CardDescription>
                                </CardHeader>
                                <CardContent className="space-y-4">
